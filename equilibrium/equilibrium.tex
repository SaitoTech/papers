...
At least one strategically-ambiguous action must exist.
...
\item only non-revelation-equivalent mechanisms can preserve the required directional coherence;

\item a reference mechanism is known that provably meets the assumptions on P2
