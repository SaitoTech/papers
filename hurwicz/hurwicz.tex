...
This appendix clarifies a set of interpretive constraints implicit throughout the
paper. Its purpose is not to introduce new claims or constructions, but to prevent
mischaracterizations that arise when analytical tools designed for direct or
revelation-equivalent mechanisms are applied outside their domain of validity.
