...
It follows that unless a fee mechanism incentivizes payment of the amount of fees defined by this equation said mechanism cannot be \textit{incentive compatible} or \textit{collusion resistant} as a subset of users must exist who can costlessly increase utility through the byzantine strategy of paying a different fee. If also follows that any fee mechanism which is defined by this equation is collusion-proof if the blockchain is a private good, as negotiations between block producers and users are in that case utility-optimizing.
